...
--select *
--from SQL_Portfoliio_Projects..CovidVaccinations
--order by 3,4
...
select *
from SQL_Portfoliio_Projects..CovidDeaths dea
join SQL_Portfoliio_Projects..CovidVaccinations vac
...
--Using CTE Common Table Expression to find RollingPeopleVaccinated vs population
